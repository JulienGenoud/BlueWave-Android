...
public class MaterialObservableGridView extends StaggeredGridView implements Scrollable {
    ...
    public MaterialObservableGridView(Context context) {
        super(context);
        init();
    }

    public MaterialObservableGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MaterialObservableGridView(Context context, AttributeSet attrs, int defStyle) {
