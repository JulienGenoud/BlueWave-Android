...
public class MainActivity extends ActionBarActivity implements BeaconConsumer, ObservableScrollViewCallbacks {
    ...
    BeaconViewerFragment mBeaconViewer = new BeaconViewerFragment();
    ...
    public void onBeaconServiceConnect() {
        mBeaconManager.setRangeNotifier(new RangeNotifier() {
            ...
            public void didRangeBeaconsInRegion(final Collection<Beacon> beacons, Region region) {
                BeaconViewerFragment beaconViewer = mBeaconViewer;
...
//                    if (0 < mScrollY) {
//                        Bundle args = new Bundle();
//                        args.putInt(ViewPagerTabScrollViewFragment.ARG_INITIAL_POSITION, 1);
//                        f.setArguments(args);
//                    }
//                    break;
//                }
